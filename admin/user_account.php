...

{
...

    {
...

        {
            ...
            //取得用户提现的资金
            $user_account = get_user_frozen($account['user_id']);
            $yue = false;
            if($user_account == 0){
                $user_account  = get_user_surplus($account['user_id']);
                $yue = true;
            ...
            $yue ? update_user_account($id,$account,$admin_note,$is_paid) : pdate_user_account1($id, $admin_note, $is_paid);
...
function update_user_account1($id, $admin_note, $is_paid)
