...
if($wxch_user_id > 0) 
{
	...
	if($wxch_order_name == 'pay' && $orders['extension_code']=='pintuan'){
			...
			$w1_url = $cfg_baseurl.$cfg_murl.'pintuan.php?act=pt_view&pt_id='.$pt_id.'&u='.$act_user."&scene_id=".$act_user;
			$w2_url = $cfg_baseurl.$cfg_murl.'pintuan.php?act=pt_view&pt_id='.$pt_id.'&u='.$follow_user."&scene_id=".$follow_user;
