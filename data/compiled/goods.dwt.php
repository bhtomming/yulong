...
changePrice();
    ...
    <h2 style=" border-bottom:1px solid #ddd ; margin-top:40px;">
      <span></span>
      <?php echo $this->_var['lang']['xinxi']; ?> 详细信息
    </h2>
...
?>
      <li><p><?php echo htmlspecialchars($this->_var['property']['name']); ?>:</p><span><?php echo $this->_var['property']['value']; ?></span></li>
       ...
       <?php endif; ?>
        <?php if ($this->_var['cfg']['show_goodsweight'] && $this->_var['goods']['goods_weight']): ?>
       <li><p><?php echo $this->_var['lang']['goods_weight']; ?></p><span><?php echo $this->_var['goods']['goods_weight']; ?></span><li>
       <?php endif; ?>
       <?php if ($this->_var['goods']['unit']): ?>
              <li><p>商品单位：</p><span><?php echo $this->_var['goods']['unit']; ?></span><li>
              <?php endif; ?>
...
<section class="index_floor is_scroll">
    <h2>
      ...
      <div class="bd">
        <ul>
           <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_32380100_1545466184');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_32380100_1545466184']):
?>
          <li>
            <a href="<?php echo $this->_var['goods_0_32380100_1545466184']['url']; ?>">
              <div class="products_kuang">
                <img src="<?php echo $this->_var['goods_0_32380100_1545466184']['goods_thumb']; ?>"></div>
              <div class="goods_name"><?php echo htmlspecialchars($this->_var['goods_0_32380100_1545466184']['short_name']); ?></div>
              <div class="price" >
              <p href="<?php echo $this->_var['goods_0_32380100_1545466184']['url']; ?>"><?php echo $this->_var['goods_0_32380100_1545466184']['fittings_price']; ?> </p>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods_0_32380100_1545466184']['goods_id']; ?>);" class="car">
                    <img src="themes/tianxin100/images/xin/cutp.png">
                </a>
              </div>
            </a>
...
<script>
	window._bd_share_config = {
		common : {
			bdText : '<?php echo $this->_var['goods']['goods_brief']; ?>',
			bdDesc : '<?php echo $this->_var['goods']['goods_name']; ?>',
			bdUrl : '<?php echo $this->_var['goods']['url']; ?>',
			bdPic : '<?php echo $this->_var['goods']['img']; ?>'
		},
		share : [{
			"bdSize" : 16
		}],
