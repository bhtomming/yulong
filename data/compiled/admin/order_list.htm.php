...
?>
  ...
  <td  align="center"><?php echo htmlspecialchars($this->_var['order']['buyer']); ?><br /><?php echo $this->_var['order']['short_order_time']; ?></td>
  ...
  <td align="center" valign="top"  nowrap="nowrap">
     <a href="order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>&order_status=<?php echo $this->_var['order']['order_status']; ?>"><?php echo $this->_var['lang']['detail']; ?></a>
