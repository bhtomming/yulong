...
?>
  <tr>
	...
	<td align="center"><?php if ($this->_var['list']['cat_id'] > 0): ?><span>
    <img src="images/<?php if ($this->_var['list']['is_tuijian'] == 1): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_tuijian', <?php echo $this->_var['list']['article_id']; ?>)" /></span><?php else: ?><img src="images/yes.gif" alt="yes" /><?php endif; ?></td>
