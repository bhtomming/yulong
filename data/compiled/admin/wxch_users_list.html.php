...
<div class="form-div">
    <form action="javascript:searchUser()" name="searchForm">
        ...
        &nbsp;<?php echo $this->_var['lang']['label_rank_name']; ?> <select name="user_type"><option value="nickname" selected="selected">会员昵称</option><option value="uname">绑定会员</option>
		<option value="province">省份</option><option value="city">城市</option></select>
...
?>
            <tr>
                <td align="center"><input type="checkbox" name="checkboxes[]" value="<?php echo $this->_var['user']['uid']; ?>" notice="<?php if ($this->_var['user']['user_money'] != 0): ?>1<?php else: ?>0<?php endif; ?>"/><?php echo $this->_var['user']['user_id']; ?></td>
                <td align="center">
                    <?php if ($this->_var['user']['headimgurl']): ?><img src="<?php echo $this->_var['user']['headimgurl']; ?>" title="<?php echo $this->_var['user']['nickname']; ?>" width="46" /> <?php endif; ?>
                </td>
