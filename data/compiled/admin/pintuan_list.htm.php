...
?>
    <tr>
      <td><input value="<?php echo $this->_var['pintuan']['act_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $this->_var['pintuan']['act_id']; ?></td>
      <td  width="25%" ><?php echo htmlspecialchars($this->_var['pintuan']['act_name']); ?></td>
      <td  width="25%" ><?php echo htmlspecialchars($this->_var['pintuan']['goods_name']); ?></td>
      <td align="right"><?php echo $this->_var['pintuan']['start_time']; ?></td>
      <td align="right"><?php echo $this->_var['pintuan']['end_time']; ?></td>
      <td align="right"><?php echo $this->_var['pintuan']['valid_order']; ?></td>
      <td align="center">
        <a href="pintuan.php?act=view&amp;act_id=<?php echo $this->_var['pintuan']['act_id']; ?>"><img src="images/icon_view.gif" title="<?php echo $this->_var['lang']['view_order']; ?>" border="0" height="16" width="16" /></a>
        <a href="pintuan.php?act=edit&amp;id=<?php echo $this->_var['pintuan']['act_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['pintuan']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16" /></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
