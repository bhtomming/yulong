...
<table width="100%" >
  ...
  <tr>
    <td class="label">提现密码:</td>
    <td><input type="password" name="password_account_replay" maxlength="20" size="20" /></td>
  </tr>
  ...
  <!--  
    <tr>
    <td class="label">最小提现金额:</td>
    <td><input type="input" name="limit_account_replay" maxlength="20" size="20"  value="<?php echo $this->_var['user']['limit_account_replay']; ?>"/></td>
  </tr>
  -->
  <?php endif; ?>
  <tr>
