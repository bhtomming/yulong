...
?>
  <tr>
	...
	<td align="center"><a href="users_parent.php?act=share_list&id=<?php echo $this->_var['user']['user_id']; ?>">点击查看</a></td>
	<td align="center">
      <a href="users_parent.php?act=edit&id=<?php echo $this->_var['user']['user_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
    </td>
  </tr>
  <?php endforeach; else: ?>
