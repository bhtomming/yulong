...
<!--
                ...
                <tr>
                    <td align="right" class="label">订单返利分成比例</td>
                    <td><input type="number" name="rebate_ratio" maxlength="150" min="0" max="100" size="10" value="<?php echo $this->_var['config']['config']['rebate_ratio']; ?>" />
                        <br />请输入数值0-100之间，（如10，则为10%，100元的订单有 10元拿出来做返利分成）
                      </td>
