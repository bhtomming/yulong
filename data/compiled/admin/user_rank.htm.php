...
?>
  <tr>
    ...
    <td align="right"><span onclick="listTable.edit(this, 'edit_scale', <?php echo $this->_var['rank']['rank_id']; ?>)"><?php echo $this->_var['rank']['award_scale']; ?></span></td>
    ...
    <td align="center"><img src="images/<?php if ($this->_var['rank']['award_on']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'award_on', <?php echo $this->_var['rank']['rank_id']; ?>)" /></td>
    <td align="center">
