<!-- $Id: wxch_msg_view.html 2013-10-16 09:59:06Z djks $ -->
<?php if ($this->_var['full_page']): ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo $this->_var['wxch_lang']['cp_home']; ?> - 微信消息查看 </title>
...
<span class="action-span1"><a href="wwxch_users.php?act=list"><?php echo $this->_var['wxch_lang']['cp_home']; ?></a> </span><span id="search_id" class="action-span1"> - 微信消息查看 </span>
...
<div class="form-div">
  <form action="javascript:searchArticle()" name="searchForm" action="wxch_users.php" >
...
<form method="POST" action="wxch_users.php?act=batch_remove" name="listForm">
<!-- start cat list -->
...
?>
    <tr>
        <td align="center" width="20%"><!--<?php if (empty ( $this->_var['list']['message'] )): ?>-->官微<!--<?php else: ?>--><?php echo $this->_var['w_user']['nickname']; ?><!--<?php endif; ?>--></td>
    <td align="center" width="8%"><?php echo $this->_var['list']['dateline']; ?></td>
    <td align="center" width="70%"><span><!--<?php if (empty ( $this->_var['list']['message'] )): ?>--><?php echo $this->_var['list']['w_message']; ?><!--<?php else: ?>--><?php echo $this->_var['list']['message']; ?><!--<?php endif; ?>--></span></td>
...
<script type="text/javascript" language="JavaScript">
    ...
    listTable.filter.uid = '<?php echo $this->_var['filter']['uid']; ?>';
