...
<div class="content">
  <?php $_from = $this->_var['user_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user_0_64542500_1548149939');if (count($_from)):
    foreach ($_from AS $this->_var['user_0_64542500_1548149939']):
?>
   
    	<a href="distribute.php?act=myorder&user_id=<?php echo $this->_var['user_0_64542500_1548149939']['user_id']; ?>&level=<?php echo $this->_var['user_0_64542500_1548149939']['level']; ?>">
        	<dl>
            	<dt><?php if ($this->_var['user_0_64542500_1548149939']['head_url'] != ''): ?><img src="<?php echo $this->_var['user_0_64542500_1548149939']['head_url']; ?>"  border="0"><?php else: ?><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/get_avatar.png"  border="0"><?php endif; ?></dt>
                <div>
                  <h3>&nbsp;会&nbsp;员&nbsp;名：<?php if ($this->_var['user_0_64542500_1548149939']['nickname']): ?><?php echo $this->_var['user_0_64542500_1548149939']['nickname']; ?><?php else: ?><?php echo $this->_var['user_0_64542500_1548149939']['user_name']; ?><?php endif; ?></h3>
                  <h3>订单数量：<?php echo $this->_var['user_0_64542500_1548149939']['order_num']; ?></h3>
                  <h3>提成金额：<?php echo $this->_var['user_0_64542500_1548149939']['order_amount']; ?></h3>
                <p>
    </p></div>
            </dl>
        </a>
