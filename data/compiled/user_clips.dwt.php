...
<section class="wrap">
		...
		<div class="per_icon_list">
		<a class="per_list" href="user.php?act=collection_list">
        				<img src="themes/tianxin100/images/icon1010.png" class="icon"/>
        				<span>我的收藏</span>
        				<img src="themes/tianxin100/images/right.png" class="right_img"/>
        			</a>
...
<?php endif; ?> 
  ...
  <?php if ($this->_var['action'] == 'point'): ?>
      ...
      <section class="wrap">
        <section class="order_box padd1 radius10">
         <style>
         .radius10 ul li a{ float:right;display:inline-block;border:1px solid #ddd; border-radius:5px;
          font-weight:bold; height:20px; padding: 0 5px;margin:0 5px 5px;color:#fff;line-height:20px; background:#bbb;color:#fff;}
         </style>
        <ul>
        <li><a href="article.php?id=8">了解积分</a></li>
        <li><a href="user.php?act=point_order">积分排行</a></li>
...
?>
      ...
      <?php endif; ?>
       <?php if ($this->_var['action'] == 'point_order'): ?>
          <header id="header">
            <div class="header_l header_return"> <a class="ico_10" href="javascript:history.go(-1)"> 返回 </a> </div>
            <h1> 会员积分排行</h1>
          </header>
          <style>
          .radius10 table tr td {line-height:2.5rem;}
          .radius10 table tr td font { display:inline-block;border:1px solid #ddd; border-radius:5px;
           font-weight:bold; height:20px;width:20px; line-height:20px; background:#bbb;color:#fff;}
           .radius10 table tr td font.red {background:red;}
           .radius10 table tr td font.blue {background:blue;}
           .radius10 table tr td font.gray {background:gray;}
           .go_tuiguang {display:block; background:#ec5151; margin:10px 10%;color:#fff; text-align:center;line-height:30px; border-radius:5px;}
          </style>
          <section class="wrap">
            <section class="order_box padd1 radius10">
           <div style="text-align:center;color:red;" > -- 您目前消费积分:<?php echo $this->_var['row']['pay_points']; ?>，等级积分:<?php echo $this->_var['row']['rank_points']; ?> 全国排名 <?php echo $this->_var['paiming']; ?> -- </div>
        <table cellpadding="3" cellspacing="1" style=" width:100%;">
          <tr>
...
<img style="padding:10px;" src="http://qr.liantu.com/api.php?bg=f3f3f3&fg=ff0000&gc=222222&el=l&w=150&m=10&text=<?php echo $this->_var['shopurl']; ?>/?u=<?php echo $this->_var['userid']; ?>"/>
      ...
      <td>推荐代码：<a href="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>&scene_id=<?php echo $this->_var['userid']; ?>" target="_blank" class="f6"><?php echo $this->_var['shopname']; ?></a> 可调用在线分享</td>
    </tr>
  </table>
...
<?php if ($this->_var['action'] == 'pnt_t_ant'): ?>
<header id="header">
  <div class="header_l header_return"> <a class="ico_10" href="user.php"> 返回 </a> </div>
  <h1> 积分兑换余额</h1>
</header>
<section class="order_box padd1 radius10 single_item">
<form action="user.php?act=points_to_account" method="POST">
请输入要兑换的积分:<input name="points" size="4" />
<input type="submit" value="确定" />
</form>
</section>
<?php endif; ?>

<?php if ($this->_var['action'] == 'ant_t_pnt'): ?>
<header id="header">
  <div class="header_l header_return"> <a class="ico_10" href="user.php"> 返回 </a> </div>
  <h1>余额兑换积分</h1>
</header>
<section class="order_box padd1 radius10 single_item">
<form action="user.php?act=account_to_point" method="POST">
请输入要兑换金额:<input name="account" size="4" />
<input type="submit" value="确定" />
</form>
</section>
<?php endif; ?>
