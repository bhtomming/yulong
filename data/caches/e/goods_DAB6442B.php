<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:50:"D:/phpStudy/WWW/yulong/themes/tianxin100/goods.dwt";i:1;s:60:"D:/phpStudy/WWW/yulong/themes/tianxin100/library/up_menu.lbi";i:2;s:66:"D:/phpStudy/WWW/yulong/themes/tianxin100/library/goods_gallery.lbi";i:3;s:61:"D:/phpStudy/WWW/yulong/themes/tianxin100/library/comments.lbi";}s:7:"expires";i:1546054450;s:8:"maketime";i:1546050850;}<!DOCTYPE html >
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width">
<title>海鸭蛋_海报展示_玉泷</title>
...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="海鸭蛋">
            <input type="hidden" name="pics" value="/images/201812/goods_img/19_G_1544738682554.jpg">
            <input type="hidden" name="gid" value="19">
            <input type="hidden" name="url" value="http://www.yulong.com/goods.php?id=19&u=5639&scene_id=5639">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="/images/201812/thumb_img/19_thumb_P_1544738682549.jpg"></a></span></li>
           </ul>
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(19)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              ...
              <dt> <span id="ECS_GOODS_AMOUNT"><sub>￥</sub>1.0</span><font>价格：50.00</font>                                  <p>购买此商品赠送100积分</p>
                                </dt>
                            </dl>
 ...
 <section id="search_ka" class="huodong">
   ...
   <ul class="youhui_list1">
              ...
              <li><img src="themes/tianxin100/images/hui.png">购买此商品可使用：100积分</li> 
                        <li><img src="themes/tianxin100/images/hui.png">购买此商品赠送： 100积分</li> 
	...
	<li style=" border-bottom:1px solid #eeeeee">
        <div class="item1">
         ...
         <span class="ui-number">
          ...
          <input type="text" class="num" id="number" onblur="changePrice();" name="number" value="1" min="1" max="994"/>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v"><sub>￥</sub>1.0</b>
         </p>
             <p>
         <span class="key">二级分销商：</span>
         <b class="p-price-v"><sub>￥</sub>0.9</b>
         </p>
             <p>
         <span class="key">一级分销商：</span>
         <b class="p-price-v"><sub>￥</sub>0.8</b>
         </p>
...
<li class="nav-kefu"><a href="javascript:tana(2);"><em class="goods_nav2"></em><span>客服</span></a> </li>
 <li><a href="javascript:collect(19)" id="favorite_add" class="collet0"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
...
<script>
  wx.config({
    ...
    timestamp: 1546050851,
    nonceStr: '3gbiwDfV8DPPCxro',
    signature: 'd9a5102b57a774f80e8c2c304fdcd333e9142e88',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '海鸭蛋',
      desc: '海鸭蛋',
      link: 'goods.php?id=19&u=5639&scene_id=5639',
      imgUrl: 'images/201812/source_img/19_G_1544738682009.png',
...
<script>
	window._bd_share_config = {
		common : {
			bdText : '',
			bdDesc : '海鸭蛋',
			bdUrl : 'http://www.yulong.com/goods.php?id=19&u=5639&scene_id=5639&u=5639&scene_id=5639',
			bdPic : 'http://www.yulong.com/images/201812/thumb_img/19_thumb_G_1544738682954.png'
		},
		share : [{
			"bdSize" : 16
		}],
