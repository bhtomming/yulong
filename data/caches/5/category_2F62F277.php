<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:53:"D:/phpStudy/WWW/yulong/themes/tianxin100/category.dwt";i:1;s:70:"D:/phpStudy/WWW/yulong/themes/tianxin100/library/goods_list_search.lbi";i:2;s:63:"D:/phpStudy/WWW/yulong/themes/tianxin100/library/footer_nav.lbi";}s:7:"expires";i:1544948223;s:8:"maketime";i:1544944623;}<!DOCTYPE html >
<html>
<head>
...
<div id="search">
  ...
  <form method="GET" class="sort" id="listform" name="listform">
    <ul class="filter-inner">
      <li class="">
      <a href="category.php?category=2&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC&keywords=#goods_list&">综合
       <i class="f-ico-arrow-d"></i></a> </li>
      <li class="">
      <a href="category.php?category=2&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC&keywords=#goods_list">人气
       </a> </li>
      <li >
      <a href="category.php?category=2&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC&keywords=#goods_list">销量
        </a></li>
      <li >
      <a href="category.php?category=2&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC&keywords=#goods_list">价格 <span>
                  </span>
       </a> </li>
    ...
    <input type="hidden" name="page" id="curpage" value="1" />
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="2">玉泷集团</a></li>
                        <input type="hidden" name="brand" value="0" />
          </ul>
...
<script type="text/javascript" src="data/static/js/common.js"></script><script type="text/javascript">
var max_page = '1' ; //分页数量
jQuery(function($){
