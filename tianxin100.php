...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    assign_dynamic('index');
		...
		if(!empty($userid)){	
			$url="http://".$_SERVER['HTTP_HOST']."/mobile/index.php?u=".$userid ."&scene_id=".$userid;
			//20141204新增分享返积分
			$dourl="http://".$_SERVER['HTTP_HOST']."/re_url.php?user_id=".$userid ."&scene_id=".$userid;
		}else{
			$url="";
			//20141204新增分享返积分
			$dourl="";
...
$goodsurl="http://wxmiqi.wushuai.net/mobile/goods.php?id=17&u=".$user_id ."&scene_id=".$user_id;
